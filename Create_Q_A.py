...
def generate_fqa_pairs(text, tokenizer, model, device):
    prompt = f"Generate factual question and answer pairs based on the following science article:\n\n{text}\n\nQ: "
